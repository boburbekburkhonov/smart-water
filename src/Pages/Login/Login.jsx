    ...
    <div className='min-vh-100 d-flex align-items-center justify-content-center '>
      <div className='container'>
        <form action="" className="form_main m-auto" onSubmit={login}>
            ...
            <input type="text" className="inputField" id="username" name='username' placeholder="Username" required />
            </div>
            ...
            <svg viewBox="64 64 896 896" focusable="false" data-icon="lock" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M832 464h-68V240c0-70.7-57.3-128-128-128H388c-70.7 0-128 57.3-128 128v224h-68c-17.7 0-32 14.3-32 32v384c0 17.7 14.3 32 32 32h640c17.7 0 32-14.3 32-32V496c0-17.7-14.3-32-32-32zM332 240c0-30.9 25.1-56 56-56h248c30.9 0 56 25.1 56 56v224H332V240zm460 600H232V536h560v304zM484 701v53c0 4.4 3.6 8 8 8h40c4.4 0 8-3.6 8-8v-53a48.01 48.01 0 10-56 0z"></path></svg>
                <input type="password" className="inputField" id="password" name='password' placeholder="Password" required />
            </div>


            <button id="button" className='mt-4 d-flex align-items-center justify-content-around'>
              <span className='login-btn-span'>Kirish</span>
            <svg className='text-primary' viewBox="64 64 896 896" focusable="false" data-icon="arrow-right" fontWeight='bold' width="2em" height="20px" fill="currentColor" aria-hidden="true"><path d="M869 487.8L491.2 159.9c-2.9-2.5-6.6-3.9-10.5-3.9h-88.5c-7.4 0-10.8 9.2-5.2 14l350.2 304H152c-4.4 0-8 3.6-8 8v60c0 4.4 3.6 8 8 8h585.1L386.9 854c-5.6 4.9-2.2 14 5.2 14h91.5c1.9 0 3.8-.7 5.2-2L869 536.2a32.07 32.07 0 000-48.4z"></path></svg>
            </button>
        </form>
      </div>
    </div>
